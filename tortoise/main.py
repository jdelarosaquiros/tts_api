...
half = True
voice = 'javi'
text = "Hi, nice to meet you. I hope we get along well."
candidates = 3
preset = 'fast'
cvvp_amount = .0
seed = None
...
tts = TextToSpeech(models_dir=MODELS_DIR, use_deepspeed=use_deepspeed, kv_cache=kv_cache, half=half)

selected_voices = voice.split(',')
print("Selected Voice:", selected_voices)
...
async def root():
    ...
    if isinstance(gen, list):
        ...
        return {"message": "Voice Generated!"}
